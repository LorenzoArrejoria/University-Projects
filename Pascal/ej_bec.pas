...
begin
     ...
     prom_edad_sist := suma_edad_sist / cont_sist;
     ...
     writeln('El monto total de becas es de: ', monto_total:0:2);
     writeln('El porcentaje del monto percibido para la "Lic. en Sistemas de Informacion" es de: %', porc_sist:0:2);
     writeln('El promedio de edad de los becarios en "Lic. en Sistemas de Informacion" es de: ', prom_edad_sist:0:2);
